...
require (
	github.com/AceMQ-Company/acemq-go-amqp v0.6.1
	github.com/AceMQ-Company/acemq-go-amqp/codec/avro v0.6.1
	github.com/AceMQ-Company/acemq-go-amqp/codec/protobuf v0.6.1
	github.com/AceMQ-Company/acemq-go-amqp/codec/toml v0.6.1
	github.com/AceMQ-Company/acemq-go-amqp/codec/yaml v0.6.1
	github.com/AceMQ-Company/acemq-go-amqp/telemetry/otel v0.6.1
